...
const userController = (
  ...
  const followUserRequest = asyncHandler(async (req: Request, res: Response) => {
    const { userId, targetUserId } = req.body;
    const result = await handleFollowUserRequest(userId, targetUserId, dbUserRepository);
    res.json({
      status: "success",
  ...
  const unfollowUserRequest = asyncHandler(async (req: Request, res: Response) => {
    const { userId, targetUserId } = req.body;
    const result = await handleUnFollowUserRequest(userId, targetUserId, dbUserRepository);
    res.json({
      status: "success",
  ...
  const cancelfollowUserRequest = asyncHandler(async (req: Request, res: Response) => {
    const { userId, targetUserId } = req.body;
    const result = await handleCancelFollowUserRequest(userId, targetUserId, dbUserRepository);
    res.json({
      status: "success",
  ...
  const acceptfollowUserRequest = asyncHandler(async (req: Request, res: Response) => {
    const { userId, targetUserId } = req.body;
    const result = await handleAcceptFollowUserRequest(userId, targetUserId, dbUserRepository);
    res.json({
      status: "success",
  ...
  const rejectfollowUserRequest = asyncHandler(async (req: Request, res: Response) => {
    const { userId, targetUserId } = req.body;
    const result = await handleRejectFollowUserRequest(userId, targetUserId, dbUserRepository);
    res.json({
      status: "success",
