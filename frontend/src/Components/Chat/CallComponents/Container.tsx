...
//   const [zgVar, setZgVar] = useState();
//   const [localStream, setLocalStream] = useState();
//   const [publichStream, setPublishStream] = useState();
...
//         let returnedToken = result?.token;
...
//             }
//           );
//           await zg.loginRoom(data.roomId.toString() , token ,{userID :currentUser._id.toString() ,username :currentUser.username} , {userUpdate: true})
...
//   const endCallFun = () => {
//     console.log("id: ", data);
//     if(zgVar && localStream && publichStream ){
//       zgVar.destroyStream(localStream)
//       zgVar.stopPublishingStream(publichStream)
