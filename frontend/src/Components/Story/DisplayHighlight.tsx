...
import { getStoriesForHighlights, gethighlightsdata } from "../../API/Post/post";
          ...
          <div className="modal-box w-full max-w-3xl text-black dark:text-gray-300 overflow-auto no-scrollbar bg-gray-200 dark:bg-gray-800">
            {selectedHighlight && (
              <div className="items-center">
               <div className="bg-gray-800 p-2 items-center flex flex-col"> <h3 className="font-bold text-lg underline p-2">
