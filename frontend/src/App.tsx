  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/home" element={<PrivateRoute element={<HomePage />} path={""} />} />
        <Route path="/signup" element={<SignUpPage />} />
        <Route path="/otp" element={<OTPPage />} />
        <Route path="/signin" element={<SignInPage />} />
        <Route path="/profile" element={<PrivateRoute element={<ProfilePage />} path={""} />} />
        <Route path="/error" element={<ErrorPage />} />
        <Route path="*" element={<ErrorPage />} /> {/* for undefined paths err pg will load */}
      </Routes>
    </BrowserRouter>
  );
}
